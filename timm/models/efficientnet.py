...
class EfficientNetFeatures(nn.Module):
    ...
    def __init__(
            ...
            act_layer=None, norm_layer=None, se_layer=None, drop_rate=0.,
...
def _gen_mobilenet_v2(
        ...
        fix_stem_head=False, pretrained=False, has_dw_skip=False,
        dw_chl_per_group=1, **kwargs):
    ...
    if has_dw_skip:
        arch_def = [
            [f'ds_r1_k3_s1_c16_dw-skip_dwg{dw_chl_per_group}'],
            [f'ir_r2_k3_s2_e6_c24_dw-skip_dwg{dw_chl_per_group}'],
            [f'ir_r3_k3_s2_e6_c32_dw-skip_dwg{dw_chl_per_group}'],
            [f'ir_r4_k3_s2_e6_c64_dw-skip_dwg{dw_chl_per_group}'],
            [f'ir_r3_k3_s1_e6_c96_dw-skip_dwg{dw_chl_per_group}'],
            [f'ir_r3_k3_s2_e6_c160_dw-skip_dwg{dw_chl_per_group}'],
            [f'ir_r1_k3_s1_e6_c320_dw-skip_dwg{dw_chl_per_group}'],
        ]
    else:
        arch_def = [
            [f'ds_r1_k3_s1_c16_dwg{dw_chl_per_group}'],
            [f'ir_r2_k3_s2_e6_c24_dwg{dw_chl_per_group}'],
            [f'ir_r3_k3_s2_e6_c32_dwg{dw_chl_per_group}'],
            [f'ir_r4_k3_s2_e6_c64_dwg{dw_chl_per_group}'],
            [f'ir_r3_k3_s1_e6_c96_dwg{dw_chl_per_group}'],
            [f'ir_r3_k3_s2_e6_c160_dwg{dw_chl_per_group}'],
            [f'ir_r1_k3_s1_e6_c320_dwg{dw_chl_per_group}'],
        ]
    round_chs_fn = partial(round_channels, multiplier=channel_multiplier)
    model_kwargs = dict(
...
def mobilenetv2_100(pretrained=False, **kwargs):
    ...
    model = _gen_mobilenet_v2('mobilenetv2_100', 1.0, pretrained=pretrained,
            dw_chl_per_group=1, **kwargs)
    return model


@register_model
def mobilenetv2_dw_100(pretrained=False, **kwargs):
    """ MobileNet V2 w/ 1.0 channel multiplier """
    model = _gen_mobilenet_v2('mobilenetv2_100', 1.0, pretrained=pretrained,
            has_dw_skip=True, dw_chl_per_group=1, **kwargs)
