...
This codebase is forked from [Compact Transformer](https://github.com/SHI-Labs/Compact-Transformers)
codebase. We further add quantization related code and resnet models for
cifar10/cifar100. Some experimental results can be found in
