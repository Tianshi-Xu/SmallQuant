...
__all__ = ["cifar10_crypto_resnet18", "cifar10_crypto_resnet34"]
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False,
            ...
            use_dual_skip=False, post_res_bn=False, use_square=False):
...
@register_model
def cifar10_crypto_resnet18(pretrained=False, progress=True, device="cpu", **kwargs):
...
@register_model
def cifar10_crypto_resnet34(pretrained=False, progress=True, device="cpu", **kwargs):
